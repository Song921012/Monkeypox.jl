@doc raw"""
    monkeypoxopt!(N::Real, θ, acc, cases, datatspan, pknown, lb, ub, alg)

Parameter Estimation

Parameters: (population, estimated parameters, acc,cases,datatspan,pknown, lb,ub,alg)
"""
function monkeypoxopt!(N, θ, acc, cases, datatspan, pknown, lb, ub, alg)
...
@doc raw"""
    controlmonkeypoxopt!(N::Real, θ, acc, cases, datatspan, pknown, lb, ub, alg)

Parameter Estimation

Parameters: (population, estimated parameters, acc,cases,datatspan,pknown, lb,ub,alg)
"""
function controlmonkeypoxopt!(N, θ, acc, cases, datatspan, pknown, lb, ub, alg)
