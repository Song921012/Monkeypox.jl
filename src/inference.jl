...
"""
function monkeypoxinference!(N, θ, acc, cases, datatspan, pknown, lb, ub)
...
@doc raw"""
    controlmonkeypoxinference!(du,u,p,t)

Bayesian inference of the data
"""
function controlmonkeypoxinference!(N, θ, acc, cases, datatspan, pknown, lb, ub)
    @model function fitmodel(data, prob1) # data should be a Vector
        ϵ ~ InverseGamma(2, 3) # ~ is the tilde character
